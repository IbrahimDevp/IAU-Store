...
<?php include('includes/left_content.php');?>
                    ...
                    if(isset($_GET['search'])){
                        if(empty($_GET['search'])){
                            echo "<h2 class='center_title_bar'>Result for <q>all</q></h2>" ;
                        }
                        else{
                            echo "<h2 class='center_title_bar'>Result for <q>".$_GET['search']. "</q></h2>";
                        }
                        ...
                        echo "<h2 class='center_title_bar'>Result for <q>".$_GET['name']. "</q></h2>";
                    }
                    ?>
                    <?php
                    //if statment for choosing between search bar and Categories
                    if(isset($_GET['search'])){
                        ?>
                        <?php  
                        ...
                        <?php  
                             $search_query=$_GET['catg'];
                              $sql= mysqli_query($dbc,"SELECT * FROM product WHERE Category LIKE '%$search_query%'");
                                 while($result = mysqli_fetch_array($sql)){
							$pid = $result['Product_ID'];
							$name = $result['Product_Name'];
							?>
                    ...
                    <?php  
                             $search_query=$_GET['manf'];
                              $sql= mysqli_query($dbc,"SELECT * FROM product WHERE Product_Manuf LIKE '%$search_query%'");
                                 while($result = mysqli_fetch_array($sql)){
							$pid = $result['Product_ID'];
							$name = $result['Product_Name'];
							?>
